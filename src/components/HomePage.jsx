 ...
 *
 * Preloading:
 *   Hovering a card triggers image preloading for that page via preloadPage().
 *   The `pages` prop is the PAGES content map from App.jsx.
 */
export default function HomePage({ setPage, dark, t, pages }) {
        ...
        >
          {TOPICS.map(({ key, label, desc }, idx) => (
            <button
              ...
              onClick={() => setPage(key)}
              onMouseEnter={(e) => {
                /* Preload this page's images as soon as the user hovers */
                handleCardHover(key)
